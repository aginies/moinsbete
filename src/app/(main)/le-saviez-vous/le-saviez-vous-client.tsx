...
export function LeSaviezVousClient({ id, text, sourceUrl, imageFilename }: LeSaviezVousClientProps) {
  return (
    <div className="w-full">
      <SaviezVousCard id={id} text={text} sourceUrl={sourceUrl} imageFilename={imageFilename} showLink={false} showToggle={false} imageHeight="h-[500px]" swipeable={true} enableAutoRefresh={true} />
    </div>
  )
}
