export const PORTAIL_LEXICAL_BASE = 'https://www.portail-lexical.fr'
...
export async function fetchWotd(): Promise<WotdResponse | null> {
  try {
...
export async function fetchWordDetails(word: string): Promise<PortailLexicalWord | null> {
  try {
...
export async function searchWords(term: string): Promise<SearchSuggestion[]> {
