      ...
      {image?.imageUrl && (
        ...
        >
          <img
            ...
            alt={image.titre}
            loading="lazy"
            className={`w-full transition-opacity ${largeImage ? 'max-h-[50vh] object-cover bg-neutral-100 dark:bg-neutral-800' : fullImage ? 'max-h-[60vh] object-contain bg-neutral-100 dark:bg-neutral-800' : 'h-48 object-cover pointer-events-none hover:opacity-90'}`}
